...
- Word selection for drawer (1–5 choices)
- Guessing: type word, get points for correct guess
- Scoring and leaderboard
- Game end with winner screen
- Basic drawing tools: brush, colors, eraser, undo, clear
...
### Bonus ✅
- OOP architecture (Player, Game, Room, MessageHandler)
- Word categories (animals, objects, food, actions, places, nature)
- Public room browser
- Avatars (emoji-based)
- Canvas sync for late joiners
- Auto word pick if drawer idles
